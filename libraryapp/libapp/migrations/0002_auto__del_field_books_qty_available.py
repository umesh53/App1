...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Books.qty_available'
        db.delete_column(u'libapp_books', 'qty_available')


    def backwards(self, orm):
        # Adding field 'Books.qty_available'
        db.add_column(u'libapp_books', 'qty_available',
